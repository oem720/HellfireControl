...
HC_INLINE Vec2::Vec2() {}
HC_INLINE Vec2::Vec2(const float* _pValues) { m_fVec = _mm_set_ps(_pValues[1], _pValues[1], _pValues[1], _pValues[0]); }
HC_INLINE Vec2::Vec2(float _fX, float _fY) { m_fVec = _mm_set_ps(_fY, _fY, _fY, _fX); }
HC_INLINE Vec2::Vec2(int _iX, int _iY) { m_fVec = _mm_set_ps(static_cast<float>(_iY), static_cast<float>(_iY), static_cast<float>(_iY), static_cast<float>(_iX)); }
HC_INLINE Vec2::Vec2(__m128 _vData) { m_fVec = _vData; }
HC_INLINE Vec2::Vec2(const Vec2&& _vOther) { (*this) = std::move(_vOther); }
HC_INLINE Vec2::Vec2(const Vec2& _vOther) { (*this) = _vOther; }
HC_MATHFUNCTION(Vec2&) Vec2::operator=(const Vec2& _vOther) { if (this != &_vOther) { this->m_fVec = _vOther.m_fVec; } return *this; }
HC_MATHFUNCTION(Vec2&) Vec2::operator=(const Vec2&& _vOther) { if (this != &_vOther) { this->m_fVec = std::move(_vOther.m_fVec); } return *this; }
HC_MATHFUNCTION(Vec2&) Vec2::operator+=(const Vec2 _vOther) { *this = *this + _vOther; return *this; }
HC_MATHFUNCTION(Vec2&) Vec2::operator-=(const Vec2 _vOther) { *this = *this - _vOther; return *this; }
HC_MATHFUNCTION(Vec2&) Vec2::operator*=(const Vec2 _vOther) { *this = *this * _vOther; return *this; }
HC_MATHFUNCTION(Vec2&) Vec2::operator*=(const float _fScale) { *this = *this * _fScale; return *this; }
HC_MATHFUNCTION(Vec2&) Vec2::operator/=(const float _fScale) { *this = *this / _fScale; return *this; }
HC_MATHFUNCTION(float&) Vec2::operator[](int _iNdx) { assert(_iNdx < 2); return m_fVec.m128_f32[_iNdx]; }
HC_MATHFUNCTION(float) Vec2::operator[](int _iNdx) const { assert(_iNdx < 2); return m_fVec.m128_f32[_iNdx]; }
...
HC_MATHFUNCTION(Vec2) Vec2::operator~() const { return Vec2(_mm_setzero_ps()); }
HC_MATHFUNCTION(Vec2) Vec2::operator-() const { return Vec2(_mm_setzero_ps()) - (*this); }
...
HC_MATHFUNCTION(float) Vec2::Length() const { return sqrtf(LengthSquared()); }
HC_MATHFUNCTION(float) Vec2::LengthSquared() const { return Dot(*this, *this); }
HC_MATHFUNCTION(void) Vec2::Normalize() { *this = (*this) * (1.0f / Length()); }
HC_MATHFUNCTION(Vec2) Vec2::Normalized() const { return (*this) * (1.0f / Length()); }
HC_MATHFUNCTION(float) Vec2::AngleBetween(Vec2 _vOther) const { return acosf(Dot(*this, _vOther)); }
...
HC_MATHFUNCTION(float) AngleBetween(Vec3 _vLeft, Vec3 _vRight) { acosf(Dot(_vLeft, _vRight)); }
...
HC_MATHFUNCTION(Vec2) Vec2::Add( Vec2 _vOther) { return *this + _vOther; }
HC_MATHFUNCTION(Vec2) Vec2::Subtract(Vec2 _vOther) { return *this + _vOther; }
HC_MATHFUNCTION(Vec2) Vec2::Scale(const float _fScale) { return *this * _fScale; }
HC_MATHFUNCTION(Vec2) Vec2::Abs() { m_fVec = _mm_andnot_ps(m_fVec, SignBitMask().m_fVec); return *this; }
HC_MATHFUNCTION(Vec2) Vec2::Zero() { return ~(*this); }
HC_MATHFUNCTION(Vec2) Vec2::Negate() { return -(*this); }
HC_MATHFUNCTION(bool) Vec2::Equals(Vec2 _vOther) const { return *this == _vOther; }
HC_MATHFUNCTION(bool) Vec2::Less(Vec2 _vOther) const { return *this < _vOther; }
HC_MATHFUNCTION(bool) Vec2::LessThanOrEquals(Vec2 _vOther) const { return *this <= _vOther; }
HC_MATHFUNCTION(bool) Vec2::Greater(Vec2 _vOther) const { return *this > _vOther; }
HC_MATHFUNCTION(bool) Vec2::GreaterThanOrEquals(Vec2 _vOther) const { return *this >= _vOther; }
HC_MATHFUNCTION(bool) Vec2::NotEquals(Vec2 _vOther) const { return *this != _vOther; }
...
HC_INLINE Vec3::Vec3(const Vec3&& _vOther) { (*this) = std::move(_vOther); }
HC_INLINE Vec3::Vec3(const Vec3& _vOther) { (*this) = _vOther; }
HC_MATHFUNCTION(Vec3&) Vec3::operator=(const Vec3&& _vOther) { if (this != &_vOther) { this->m_fVec = std::move(_vOther.m_fVec); } return *this; }
HC_MATHFUNCTION(Vec3&) Vec3::operator=(const Vec3& _vOther) { if (this != &_vOther) { this->m_fVec = _vOther.m_fVec; } return *this; }
HC_MATHFUNCTION(Vec3&) Vec3::operator+=(const Vec3 _vOther) { *this = *this + _vOther; return *this; }
HC_MATHFUNCTION(Vec3&) Vec3::operator-=(const Vec3 _vOther) { *this = *this - _vOther; return *this; }
HC_MATHFUNCTION(Vec3&) Vec3::operator*=(const Vec3 _vOther) { *this = *this * _vOther; return *this; }
HC_MATHFUNCTION(Vec3&) Vec3::operator*=(const float _fScale) { *this = *this * _fScale; return *this; }
HC_MATHFUNCTION(Vec3&) Vec3::operator/=(const float _fScale) { *this = *this / _fScale; return *this; }
HC_MATHFUNCTION(float) Vec3::operator[](int _iNdx) const { assert(_iNdx < 3); return m_fVec.m128_f32[_iNdx]; }
HC_MATHFUNCTION(float&) Vec3::operator[](int _iNdx) { assert(_iNdx < 3); return m_fVec.m128_f32[_iNdx]; }
...
HC_MATHFUNCTION(float) operator&(Vec3 _vLeft, Vec3 _vRight) { return Sum(_vLeft * _vRight); }
HC_MATHFUNCTION(Vec3) Vec3::operator~() const { return Vec3(_mm_setzero_ps()); }
HC_MATHFUNCTION(Vec3) Vec3::operator-() const { return Vec3(_mm_setzero_ps()) - *this; }
...
HC_MATHFUNCTION(float) Vec3::Length() const { return sqrtf(Dot(*this, *this)); }
HC_MATHFUNCTION(float) Vec3::LengthSquared() const { return Dot(*this, *this); }
HC_MATHFUNCTION(Vec3) Vec3::Normalize() { return *this * (1.0f / Length()); }
HC_MATHFUNCTION(float) Vec3::AngleBetween(Vec3 _vOther) { return acosf(Dot(*this, _vOther)); }
HC_MATHFUNCTION(float) Length(Vec3 _vVector) { return sqrtf(Dot(_vVector, _vVector)); }
HC_MATHFUNCTION(float) LengthSquared(Vec3 _vVector) { return Dot(_vVector, _vVector); }
HC_MATHFUNCTION(Vec3) Normalize(Vec3 _vVector) { return _vVector * (1.0f / Length(_vVector)); }
...
HC_MATHFUNCTION(Vec3) Vec3::Add(Vec3 _vOther) { return (*this) + _vOther; }
HC_MATHFUNCTION(Vec3) Vec3::Subtract(Vec3 _vOther) { return (*this) - _vOther; }
HC_MATHFUNCTION(Vec3) Vec3::Scale(const float _fScale) { return (*this) * _fScale; }
HC_MATHFUNCTION(Vec3) Vec3::Abs() { return Vec3(_mm_andnot_ps(m_fVec, SignBitMask().m_fVec)); }
HC_MATHFUNCTION(Vec3) Vec3::Negate() { return -(*this); }
HC_MATHFUNCTION(Vec3) Vec3::Zero() { return ~(*this); }
HC_MATHFUNCTION(bool) Vec3::Equals(Vec3 _vOther) const { return (*this) == _vOther; }
HC_MATHFUNCTION(bool) Vec3::Less(Vec3 _vOther) const { return (*this) < _vOther; }
HC_MATHFUNCTION(bool) Vec3::LessThanOrEquals(Vec3 _vOther) const { return (*this) <= _vOther; }
HC_MATHFUNCTION(bool) Vec3::Greater(Vec3 _vOther) const { return (*this) > _vOther; }
HC_MATHFUNCTION(bool) Vec3::GreaterThanOrEquals(Vec3 _vOther) const { return (*this) >= _vOther; }
HC_MATHFUNCTION(bool) Vec3::NotEquals(const Vec3 _vOther) const { return (*this) != _vOther; }
HC_MATHFUNCTION(float&) Vec3::X() { return m_fVec.m128_f32[0]; }
HC_MATHFUNCTION(float&) Vec3::Y() { return m_fVec.m128_f32[1]; }
HC_MATHFUNCTION(float&) Vec3::Z() { return m_fVec.m128_f32[2]; }
HC_MATHFUNCTION(float) Vec3::X() const { return _mm_cvtss_f32(m_fVec); }
HC_MATHFUNCTION(float) Vec3::Y() const { return _mm_cvtss_f32(_mm_shuffle_ps(m_fVec, m_fVec, _MM_SHUFFLE(1, 1, 1, 1))); }
HC_MATHFUNCTION(float) Vec3::Z() const { return _mm_cvtss_f32(_mm_shuffle_ps(m_fVec, m_fVec, _MM_SHUFFLE(2, 2, 2, 2))); }
HC_MATHFUNCTION(Vec2) Vec3::XX() const { return Vec2(HC_SHUFFLE2F(*this, 0, 0)); }
HC_MATHFUNCTION(Vec2) Vec3::YY() const { return Vec2(HC_SHUFFLE2F(*this, 1, 1)); }
HC_MATHFUNCTION(Vec2) Vec3::ZZ() const { return Vec2(HC_SHUFFLE2F(*this, 2, 2)); }
HC_MATHFUNCTION(Vec2) Vec3::XY() const { return Vec2(HC_SHUFFLE2F(*this, 0, 1)); }
HC_MATHFUNCTION(Vec2) Vec3::XZ() const { return Vec2(HC_SHUFFLE2F(*this, 0, 2)); }
HC_MATHFUNCTION(Vec2) Vec3::YX() const { return Vec2(HC_SHUFFLE2F(*this, 1, 0)); }
HC_MATHFUNCTION(Vec2) Vec3::YZ() const { return Vec2(HC_SHUFFLE2F(*this, 1, 2)); }
HC_MATHFUNCTION(Vec2) Vec3::ZX() const { return Vec2(HC_SHUFFLE2F(*this, 2, 0)); }
HC_MATHFUNCTION(Vec2) Vec3::ZY() const { return Vec2(HC_SHUFFLE2F(*this, 2, 1)); }
HC_MATHFUNCTION(Vec2) Vec3::RR() const { return Vec2(HC_SHUFFLE2F(*this, 0, 0)); }
HC_MATHFUNCTION(Vec2) Vec3::GG() const { return Vec2(HC_SHUFFLE2F(*this, 1, 1)); }
HC_MATHFUNCTION(Vec2) Vec3::BB() const { return Vec2(HC_SHUFFLE2F(*this, 2, 2)); }
HC_MATHFUNCTION(Vec2) Vec3::RG() const { return Vec2(HC_SHUFFLE2F(*this, 0, 1)); }
HC_MATHFUNCTION(Vec2) Vec3::RB() const { return Vec2(HC_SHUFFLE2F(*this, 0, 2)); }
HC_MATHFUNCTION(Vec2) Vec3::GR() const { return Vec2(HC_SHUFFLE2F(*this, 1, 0)); }
HC_MATHFUNCTION(Vec2) Vec3::GB() const { return Vec2(HC_SHUFFLE2F(*this, 1, 2)); }
HC_MATHFUNCTION(Vec2) Vec3::BR() const { return Vec2(HC_SHUFFLE2F(*this, 2, 0)); }
HC_MATHFUNCTION(Vec2) Vec3::BG() const { return Vec2(HC_SHUFFLE2F(*this, 2, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::XXX() const { return Vec3(HC_SHUFFLE3F(*this, 0, 0, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::XXY() const { return Vec3(HC_SHUFFLE3F(*this, 0, 0, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::XXZ() const { return Vec3(HC_SHUFFLE3F(*this, 0, 0, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::XYX() const { return Vec3(HC_SHUFFLE3F(*this, 0, 1, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::XYY() const { return Vec3(HC_SHUFFLE3F(*this, 0, 1, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::XZX() const { return Vec3(HC_SHUFFLE3F(*this, 0, 2, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::XZY() const { return Vec3(HC_SHUFFLE3F(*this, 0, 2, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::XZZ() const { return Vec3(HC_SHUFFLE3F(*this, 0, 2, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::YXX() const { return Vec3(HC_SHUFFLE3F(*this, 1, 0, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::YXY() const { return Vec3(HC_SHUFFLE3F(*this, 1, 0, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::YXZ() const { return Vec3(HC_SHUFFLE3F(*this, 1, 0, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::YYX() const { return Vec3(HC_SHUFFLE3F(*this, 1, 1, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::YYY() const { return Vec3(HC_SHUFFLE3F(*this, 1, 1, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::YYZ() const { return Vec3(HC_SHUFFLE3F(*this, 1, 1, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::YZX() const { return Vec3(HC_SHUFFLE3F(*this, 1, 2, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::YZY() const { return Vec3(HC_SHUFFLE3F(*this, 1, 2, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::YZZ() const { return Vec3(HC_SHUFFLE3F(*this, 1, 2, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::ZXX() const { return Vec3(HC_SHUFFLE3F(*this, 2, 0, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::ZXY() const { return Vec3(HC_SHUFFLE3F(*this, 2, 0, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::ZXZ() const { return Vec3(HC_SHUFFLE3F(*this, 2, 0, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::ZYX() const { return Vec3(HC_SHUFFLE3F(*this, 2, 1, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::ZYY() const { return Vec3(HC_SHUFFLE3F(*this, 2, 1, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::ZYZ() const { return Vec3(HC_SHUFFLE3F(*this, 2, 1, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::ZZX() const { return Vec3(HC_SHUFFLE3F(*this, 2, 2, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::ZZY() const { return Vec3(HC_SHUFFLE3F(*this, 2, 2, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::ZZZ() const { return Vec3(HC_SHUFFLE3F(*this, 2, 2, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::RRR() const { return Vec3(HC_SHUFFLE3F(*this, 0, 0, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::RRG() const { return Vec3(HC_SHUFFLE3F(*this, 0, 0, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::RRB() const { return Vec3(HC_SHUFFLE3F(*this, 0, 0, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::RGR() const { return Vec3(HC_SHUFFLE3F(*this, 0, 1, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::RGG() const { return Vec3(HC_SHUFFLE3F(*this, 0, 1, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::RBR() const { return Vec3(HC_SHUFFLE3F(*this, 0, 2, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::RBG() const { return Vec3(HC_SHUFFLE3F(*this, 0, 2, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::RBB() const { return Vec3(HC_SHUFFLE3F(*this, 0, 2, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::GRR() const { return Vec3(HC_SHUFFLE3F(*this, 1, 0, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::GRG() const { return Vec3(HC_SHUFFLE3F(*this, 1, 0, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::GRB() const { return Vec3(HC_SHUFFLE3F(*this, 1, 0, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::GGR() const { return Vec3(HC_SHUFFLE3F(*this, 1, 1, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::GGG() const { return Vec3(HC_SHUFFLE3F(*this, 1, 1, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::GGB() const { return Vec3(HC_SHUFFLE3F(*this, 1, 1, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::GBR() const { return Vec3(HC_SHUFFLE3F(*this, 1, 2, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::GBG() const { return Vec3(HC_SHUFFLE3F(*this, 1, 2, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::GBB() const { return Vec3(HC_SHUFFLE3F(*this, 1, 2, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::BRR() const { return Vec3(HC_SHUFFLE3F(*this, 2, 0, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::BRG() const { return Vec3(HC_SHUFFLE3F(*this, 2, 0, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::BRB() const { return Vec3(HC_SHUFFLE3F(*this, 2, 0, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::BGR() const { return Vec3(HC_SHUFFLE3F(*this, 2, 1, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::BGG() const { return Vec3(HC_SHUFFLE3F(*this, 2, 1, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::BGB() const { return Vec3(HC_SHUFFLE3F(*this, 2, 1, 2)); }
HC_MATHFUNCTION(Vec3) Vec3::BBR() const { return Vec3(HC_SHUFFLE3F(*this, 2, 2, 0)); }
HC_MATHFUNCTION(Vec3) Vec3::BBG() const { return Vec3(HC_SHUFFLE3F(*this, 2, 2, 1)); }
HC_MATHFUNCTION(Vec3) Vec3::BBB() const { return Vec3(HC_SHUFFLE3F(*this, 2, 2, 2)); }
